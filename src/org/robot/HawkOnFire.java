...
//- run -------------------------------------------------------------------------------------------------------------------------------------
	public void run()
	{
		...
		do {
			...
			// wai	t until you have scanned all other bots. this should take around 7 to 9 ticks.
...
//- eval position ---------------------------------------------------------------------------------------------------------------------------
	public static double evaluate(Point2D.Double p, double addLast) {
		...
		Enumeration enum_ = enemies.elements();
		while (enum_.hasMoreElements()) {
			microEnemy en = (microEnemy)enum_.nextElement();
...
//- scan event ------------------------------------------------------------------------------------------------------------------------------
	public void onScannedRobot(ScannedRobotEvent e)
	{
		...
		System.out.println("Enemy position ->  " + en.pos);
...
//- microEnemy ------------------------------------------------------------------------------------------------------------------------------
	...
	public void onPaint(Graphics2D g) {
		g.fillRect((int) nextDestination.getX(),(int) nextDestination.getY(), 10, 10);
	}
}